...
table.order.b <- X2.table.order.b %>% gt(rowname_col = "Order") %>% 
  tab_stubhead(label = md("**Order**")) %>%
  tab_header(title = md("**Chi-Squared Test Results for Between-Genus Coinfection by Avian Order**")) %>%
  fmt_number(columns = c(Observed, Expected, Difference, Std.Res), decimals = 2) %>%
  cols_align(columns = c(Observed, Expected, Difference, Std.Res), align = "center") %>%
  cols_label(Observed = md("*Observed counts*"),
             Expected = md("*Expected counts*"),
...
table.family.w <- X2.table.family.w %>% gt(rowname_col = "Family") %>% 
  ...
  tab_header(title = md("**Chi-Squared Test Results for Within-Genus Coinfection by Avian Family**")) %>%
  fmt_number(columns = c(Observed, Expected, Difference, Std.Res), decimals = 2) %>%
  cols_align(columns = c(Observed, Expected, Difference, Std.Res), align = "center") %>%
  cols_label(Observed = md("*Observed counts*"),
             Expected = md("*Expected counts*"),
...
table.family.b <- X2.table.family.b %>% gt(rowname_col = "Family") %>% 
  tab_stubhead(label = md("**Family**")) %>%
  tab_header(title = md("**Chi-Squared Test Results for Between-Genus Coinfection by Avian Family**")) %>%
  fmt_number(columns = c(Observed, Expected, Difference, Std.Res), decimals = 2) %>%
  cols_align(columns = c(Observed, Expected, Difference, Std.Res), align = "center") %>%
  cols_label(Observed = md("*Observed counts*"),
             Expected = md("*Expected counts*"),
  ...
  data_color(columns = Std.Res,
             colors = scales::col_numeric(
               ...
               domain = c(-8, 8)))
table.family.b
gtsave(table.order.b, "Chi-squared between-genus family.png")
```
...
table.genus.w <- X2.table.genus.w %>% gt(rowname_col = "Genus") %>% 
  ...
  tab_header(title = md("**Chi-Squared Test Results for Within-Genus Coinfection by Avian Genus**")) %>%
  fmt_number(columns = c(Observed, Expected, Difference, Std.Res), decimals = 2) %>%
  cols_align(columns = c(Observed, Expected, Difference, Std.Res), align = "center") %>%
  cols_label(Observed = md("*Observed counts*"),
             Expected = md("*Expected counts*"),
...
table.genus.b <- X2.table.genus.b %>% gt(rowname_col = "Genus") %>% 
  tab_stubhead(label = md("**Genus**")) %>%
  tab_header(title = md("**Chi-Squared Test Results for Between-Genus Coinfection by Avian Genus**")) %>%
  fmt_number(columns = c(Observed, Expected, Difference, Std.Res), decimals = 2) %>%
  cols_align(columns = c(Observed, Expected, Difference, Std.Res), align = "center") %>%
  cols_label(Observed = md("*Observed counts*"),
             Expected = md("*Expected counts*"),
  ...
  data_color(columns = Std.Res,
             colors = scales::col_numeric(
               ...
               domain = c(-8, 8)))
table.genus.b
gtsave(table.order.b, "Chi-squared between-genus genus.png")
```
...
table.species.w <- X2.table.species.w %>% gt(rowname_col = "Species") %>% 
  ...
  tab_header(title = md("**Chi-Squared Test Results for Within-Genus Coinfection by Avian Species**")) %>%
  fmt_number(columns = c(Observed, Expected, Difference, Std.Res), decimals = 2) %>%
  cols_align(columns = c(Observed, Expected, Difference, Std.Res), align = "center") %>%
  cols_label(Observed = md("*Observed counts*"),
             Expected = md("*Expected counts*"),
