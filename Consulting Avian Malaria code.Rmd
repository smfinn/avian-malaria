...
coinf_species <- data.frame(Host_species = co$Var1[co$Var2==0],
                            ...
                            yes.Pw = as.numeric(cPw$Var2[cPw$Var2==1]),
                            no.Pw = as.numeric(cPw$Var2[cPw$Var2==0]),
                            yes.Hw = as.numeric(cHw$Var2[cHw$Var2==1]),
                            no.Hw = as.numeric(cHw$Var2[cHw$Var2==0]))
...
coinf_species <- coinf_species[,c("Host_species", "coinf_within_species", 
                                  "coinf_between_species", "coinf_Lwithin_species", "coinf_Pwithin_species", "coinf_Hwithin_species")]
...
nested1 <- lmer(any_coinf_within ~ Year + Elevation + Country + 
                (Host_order | Host_genus),
              data = malaria)
summary(nested1)
```
